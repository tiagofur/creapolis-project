...
/// Servicio para exportar Gantt Chart
class GanttExportService {
  /// Captura el widget como imagen y la comparte
  static Future<void> exportAsImage(GlobalKey key, String projectName) async {
    try {
  ...
  static Future<String?> saveAsImage(GlobalKey key, String projectName) async {
    try {
      final RenderRepaintBoundary boundary =
          key.currentContext!.findRenderObject() as RenderRepaintBoundary;
