      ...
      child: Column(
        ...
        children: [
          SizedBox(
            width: size ?? 40,
            height: size ?? 40,
            child: CircularProgressIndicator(strokeWidth: (size ?? 40) / 10),
          ),
          if (message != null) ...[
...
/// Widget para overlay de loading sobre contenido existente
...
/// Widget para mostrar shimmer loading (skeleton)
